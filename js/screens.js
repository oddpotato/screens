...
const defaultPeriod = 10,
      urls = [
          ...
          { period: 10, url: "https://app.nos.nl/datavisualisatie/2020/amerikaanse-presidentsverkiezingen/ap-widget.html" },
          //{ period: 10, url: "./cal.html" },
          { period: 5, url: "https://coronavirus.data.gov.uk/" },
          { period: 5, url: "https://coronavirus.data.gov.uk/details/cases?areaType=ltla&areaName=Tower%20Hamlets" },
          //{ period: 10, url: "./dashboard.html" },
          { period: 10, url: "https://app.nos.nl/datavisualisatie/2020/amerikaanse-presidentsverkiezingen/ap-widget.html" },
